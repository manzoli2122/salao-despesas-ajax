        ...
        <div class="row">
            <section class="text-center placeholders">      
                <div class="col-12 col-sm-12">
                    <h1>
                        Liquido a receber R$ {{number_format($model->valorSalarioLiquido(), 2,',' , '')}}	
                        @permissao('salario-cadastrar')
                            <button style="float:right;" class="btn btn-success btn" onclick="modelCreate( '{{ route('despesas.ajax.create') }}'   )" title="Pagar Salário">
